...
Checking, the std deviation  is `r sd(wtp)` (coded as  `sd(wtp)`). The exact nuber will vary each time you run the simulation in R but it will generally be close to 15.
