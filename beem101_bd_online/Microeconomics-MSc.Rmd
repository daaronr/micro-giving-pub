...
**Risk aversion, choices** Define risk aversion formally and intuitively. Describe one choice that a risk nuetral person might make that a risk-averse person would never make. Describe  a particular \textit{measure} of risk-aversion that would allow us to rank individuals according to their level of risk aversion, considering the strengths and weaknesses of this measure.
