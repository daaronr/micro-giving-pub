...
```{r  fig.cap = '', out.width='70%', fig.asp=.7, fig.align='center',  echo = FALSE}
...
There are also interesting ways to measure the 'extent' of violations of the revealed preference axioms. 
...
More advanced material is considered further below.
