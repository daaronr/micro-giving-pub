...
\
The graph of $x_i(\mathbf{p},I)$ in $I$ is the 'Engel curve'.
...
O-R formally define a monopolistic market. 
...
Their definition and approach is unusual because:
...
They note that these functions are 'decreasing' functions: this means that for higher values of the argument, the output of the function is *not* higher. In other words, we are considering demand functions that are decreasing, or at least not increasing in price. This rules out the 'Giffen' good, I believe. 
