...
`r format_with_col("Text in brown usually refers to questions you should  try to answer on your own (and I sometimes provide suggested answers in a folding box or footnonte. Try to answer it yourself first.)","brown")`
...
Boxes with this color indicate 'warnings' ... usually highlighting ways that students often *misunderstand* particular content.
...
###  Sec. \@ref(uncertainty) [Preferences under uncertainty (and over time)](#uncertainty) {-}

- 'Expected Utility'
- risk-aversion, finance and diversification
   time-preference and discounting (1 week)
...
```{block2,  type='fold'}
The assesment is likely to be a combination of a midterm examination, and a project and presentation due by end of term. As of 16 Aug 2020 I am waiting for final approval on this.
```
...
- The symbolic language and notation of maths
...
3. Some elements of **Set theory**, including

- Open and closed sets
- Subsets, ordered sets, unions and intersections
...
Consider: How wo make this a meaningful 'model with assumptions'?  *I could imagine it as below (unfold).*
...
## Preferences and utility {#pref-util}
...
#### (Standard assumptions over) properties of preferences  {-}
