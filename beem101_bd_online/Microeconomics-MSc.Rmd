...
Because of this second effect the monopolist may set the quantity intended for the low type *below* 1. This would socially inefficient;\* if this is the case then the monopolist negatively 'distorts' the quantity (or quality) intended for the low type in order to reduce the rent it must pay to the high type.
...
<div class="marginnote">
This draws from Laffont and Martimort (2002), sect.ion 2.1.5.2, which in turn draws from Maskin and Riley (1984)
</div>
...
# Monopoly pricing: An example using R {-}
