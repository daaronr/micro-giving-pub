...
```{r  fig.cap = 'Famous photograph by Ansel Adams, who loved black and white photography, colorised using De-Oldify by Jason Antic', out.width='70%', fig.asp=.4, fig.align='center',  echo = FALSE}
...
<div class="marginnote">
DR Todo: I intend to add a video here discussing these properties
</div>
