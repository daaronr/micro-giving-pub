...
Let the players’ sets of actions be $A1 = \{1,3,5,...,99,\infty\}$ and $A2 = $\{2,4,6,...,100,\infty\}$, where the action $t4 means stop at period $t$ and the action $\infty$ means "never stop."
...
Note that 'cheap talk' is a bigger topic in game theory. 
