...
### Project, discussion of research, recap (1/2 week) {#proj-outline}
...
### Supplement: [Behavioural economics: Selected further concepts](#more_be) (1 week) {-}
...
<div class="marginnote">
TODO: I intend to include a video here covering convexity, monotonicity, and some of the implications
</div>
...
```{block2,  type='inputq'}
This is a convenient assumption, but not one that is reasonable in all cases. Can you give some insight as to why not, and give some examples of cases where the indifference curves between two goods may fail to be convex ... and may be concave, at least within certain regions?
```
...
#### More formal and general concept: [quasiconcavity (optional, linked as supplement)](#quasi-conc)   {-}
...
#### At an optimal consumption choice (given above assumptions, see above note) {-}
...
If time permits, I will include some relevant advanced material, adding it below.
...
Consumer surplus (Undergraduate definition: Nicholson and Snyde)
...
<div class="marginnote">
 *In other words, if you said to a consumer 'this product will stop being produced/offered  unless you pay us enough money',  this is the maximum amount the consumer would be will be willing to pay to keep the product on the market,  at its current price.</div>
...
```{r  fig.cap = 'Source: Nicholson and Snyder, 2010', out.width='70%', fig.asp=.4, fig.align='center',  echo = FALSE}
