...
- **Game theory** : ‘Choices and outcomes in **strategic settings**', using the tools and language of Game Theory (time-permitting, asymmetric information and ‘Principal-Agent’ models). Evidence. ($\approx$ 20-25\%)
