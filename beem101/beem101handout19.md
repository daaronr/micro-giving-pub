...
<!---
The early nineteenth century was a period of considerable controversy in economics, especially in England. The two most pressing issues of the day were whether international trade was having a negative effect on the economy and whether industrial growth was harming farmland and other natural resources
It is testimony to the timelessness of economic questions that these are some of the same issues that dominate political discussions in the United States (and elsewhere) today. One of the most influential contributors to the earlier debates was the British financier and pamphleteer David Ricardo (1772–1823).
-->
...
\textcolor{RawSienna}{ This is a simple case of the implicit function theorem, essentially $U(X,Y)=c$ defines an implicit function $Y(X)$, whose slope is the negative of the ratio of the derivatives.}
...
\includegraphics[height=2in]{picsfigs/consumerlagrangian.png}
...
\textcolor{RawSienna}{ Tough questions (final exam-worthy):}
...
Graphically, how much \$ would have been enough to compensate for abstaining?^[\textcolor{RawSienna}{ Hard question, foreshadowing future concepts like the inefficiency of in-kind subsidies... How much would Willie need to be paid to get him to $U_3$ \emph{without} the restriction?  Is this more or less than \$5k?}]
...
\includegraphics[height=1.6in]{picsfigs/Quasilinear_utility.png}
...
*Notes:* \textcolor{gray}{Purchases in excess of $X_D$ are at a lower price. Unlikely price programme which *exactly* makes consumer indifferent. Lower slope after $X_D$: still locate at A, higher slope: buy larger quantity.}
...
... quantity demanded for a substitute good B will go in the *same* direction as the price of A.^[\textcolor{RawSienna}{} These 'cross-price effects' include both *substitution* and *income* effects. (See micro quiz 3.3).]
...
\includegraphics[height=2.5in]{picsfigs/costmin1.png}
...
\includegraphics[height=2.5in]{picsfigs/costmin2.png}
...
\includegraphics[height=2.5in]{picsfigs/costmin3.png}
...
\includegraphics[height=2in]{picsfigs/pcmcmr.png}
-->
...
*Note:* \textcolor{gray}{Some parts of this material relate strongly to game theory. I will give you a preview of game theory as we consider these, and we may return to these examples in our game theory section.}
...
\textcolor{RawSienna}{ or, allowing heterogeneous tastes, achieve a “potential Pareto improvement”; those who benefit could compensate those who are harmed and still all would be better off.}
...
<!---
\textcolor{gray}{This material is an 'aside', as we will not return to uncertainty until much later. But it is an extremely important aside!!}
-->
...
\textcolor{gray}{ Note, there are some debates, e.g., between 'Bayesians' and 'Frequentists' over the meaning of probability.}
...
\textcolor{gray}{also called the *mean* of the random variable $X$, denoted as $\mu$.}
...
\textcolor{RawSienna}{} \textcolor{gray}{Note that when we were choosing between two goods under certainty,
...
\textcolor{RawSienna}{} \textcolor{gray}{This framework is justified by certain 'reasonable axioms' we might expect choices under uncertainty to follow,
...
\textcolor{RawSienna}{} \textcolor{gray}{We might think that such insurance is provided at its true marginal cost; however there are various reasons why the cost to firms may be above this, including transactions cost, moral hazard, and adverse selection}
...
\textcolor{gray}{Note that these ideas are also relevant to intertemporal substitution and to social welfare functions}
...
\includegraphics[height=3in]{picsfigs/optionsvalue_blackscholes.png}
...
\textcolor{gray}{Asymmetric information (see bottom of this file), Behavioral economics coming up}
...
*Note:* \textcolor{gray}{This fancy terminology seems confusing and unnecessary.  The reason for it involves more formal definitions of 'extensive' and 'normal' games and some deeper technical issues that we skip here.}
...
\textcolor{RawSienna}{ There are differences between 'rationalizable' and 'survives ISD' but for our purposes these are the same}
...
\textcolor{RawSienna}{} \textcolor{gray}{Some texts and authors make this point about 'unpredictability' but others disagree (including myself). Making sure that it is impossible to predict your later play from your previous is only important if you are playing the same game repeatedly, and being observed.}

\textcolor{RawSienna}{} \textcolor{gray}{It makes a bit more sense if we think about 'populations.
...
$$(-2) \times (1 + g + g^2 + g^3 + \bigskip ) \geq (-1) + -3 \times (g + g^2 + g^3 + \bigskip)$$

\bigskip

$$g + g^2 + g^3 + \bigskip \geq 1$$
...
\includegraphics[height=2.5in]{picsfigs/brsheep.png}
...
\textcolor{red}{This result is now in question!} The strongest results have failed to replicate. See a popular discussion [here](https://www.vox.com/science-and-health/2018/6/6/17413000/marshmallow-test-replication-mischel-psychology).
...
\textcolor{RawSienna}{} \textcolor{gray}{The utilities, and decisions, of family members are highly connected. There is an ongoing debate and research programme considering when to model a household's decisions as 'unitary' and when to consider the individual preferences of the household members.}
...
\textcolor{RawSienna}{ see <https://davidreinstein.wordpress.com/research-and-publications/> under 'working papers'}
