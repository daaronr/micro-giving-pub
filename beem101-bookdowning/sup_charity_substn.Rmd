...
\begin{tabular}
[c]{ll}\hline\hline
**Model** & \textbf{Net Substitution?} \\\hline
...
Impact Philanthropy (concave) & Substitution scales with "impact" \\
 & of shocked gift \\
Tithing/Fixed Purse/Homogeneous & Complete (perfect crowding-out)\\\hline
\end{tabular}
...
```{r  fig.cap = '', out.width='60%', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("picsfigs/firstwave_means_ed.png")
```

***

```{r  fig.cap = '', out.width='60%', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("picsfigs/secondwave_Ameans_ed.png")
```
...
```{r  fig.cap = '', out.width='4.3in', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("picsfigs/priceelast_reinstein2012.png")
```
...
```{r  fig.cap = '', out.height='0.9in', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("picsfigs/ektreatments.png")
```
...
```{r  fig.cap = '', out.width='60%', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("picsfigs/sliderbars.png")
```
...
```{r  fig.cap = '', out.width='4.2in', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("picsfigs/ek_effortresponse.png")
```
...
```{r  fig.cap = '', out.width='60%', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("picsfigs/ekpriceresponse.png")
```
...
\footnote{Small donors may be mainly driven by temporary shocks and personal appeals, larger givers may have concave multi-charity warm-glow preferences.
...
```{r  fig.cap = '', out.width='60%', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("picsfigs/distinctcat_resid_psid.png")
```
...
```{r  fig.cap = '', out.width='60%', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("picsfigs/donkers_mailings.png")
```
...
\footnote{Cannibalization is estimated to be about 63\%, so mailings are profitable for the charity as long as the costs are lower than 37% of the revenues
...
```{r  fig.cap = '', out.width='60%', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("askforCRUK.png")
```

***

```{r  fig.cap = '', out.width='60%', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("askSTC.png")
```

***

```{r  fig.cap = '', out.width='60%', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("askctd.png")
```
...
#Group project work (iii), feedback
