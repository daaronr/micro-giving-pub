...
Twitter: \@givingtools <a href="https://twitter.com/GivingTools?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-show-count="false">Follow </a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
**Differing views** on the use of economic models^[We will return to this in our discussions, and again when we consider hte use of experiments. See the readings/notes on readings.]
...
Some of the tools used in this module are being covered in your 'Optimization' and Econometric modules. I'm in contact with these instructors.
