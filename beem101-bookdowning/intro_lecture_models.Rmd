...
## Goals of this lecture (and accompanying self-study), Coverage
...
- Plus research discussion sessions in alternate weeks, if you are interested
...
- Enrichment texts (have a look at in case you are thinking of going for a PhD in economics or in doing/applying advanced microeconomic theory in your dissertation)
    - Microeconomic Theory: Basic Principles and Extension (also by Nicholson and Snyder) somewhat more maths and formalism than NS - Intermediate Microeconomics and its applications, and some extensions (but fewer applications)
    - Nechyba 'Intermediate Microeconomics' seems to be a step up from this in maths and formalism
    - more rigorous and mathematical theory as well as good discussions of  empirical and applied research is David Autor's MIT Open Courseware "Microeconomic Theory and Public Policy"; referenced throughout
...
```
```{r  fig.cap = '', out.width='1in', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("picsfigs/ricardo.png")
```
```{r  fig.cap = '', out.width='1in', fig.asp=.4, fig.align='center',  echo = FALSE}
...
- `r format_with_col("Why/when should this not hold?","blue")`
...
`r format_with_col(" Previous slides had the first statement as 'We should increase the minimum wage to help low income workers.'  Consider: why do I think this was not a good parallel?","RawSienna")`
...
`r format_with_col("Adv math: Note, in general, we need as many equations as unknowns (above 2 of each) to *possibly","RawSienna")` be able to find a solution.  However, some sets of equations have *no* solution, and some may have \emph{multiple* solutions.  Consider plotting overlapping lines, or parrallel lines, and looking for the point(s) of intersection.}
...
*Note: This is a fairly difficult concept*
