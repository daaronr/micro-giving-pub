...
Next, plot similar BRF for husband, on other axis...
...
<aside class="notes">Stag,Stag and Hare,Hare are NE; the former is 'payoff-dominant' but the latter is 'risk-dominant' </aside>
...
<aside class="notes">Note: don't worry about the 'normal form' of sequential games; we will only use the extensive form for these
