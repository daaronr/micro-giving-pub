...
<img src="skillsbar.png" width="70%" style="display: block; margin: auto;" />
...
<img src="antaphid.jpg" width="80%" height="1.8in" style="display: block; margin: auto;" />
...
<img src="plotaquadfncnR.png" width="80%" height="1.5in" style="display: block; margin: auto;" />
...
<img src="plotaquadfncn_andderiv.png" width="80%" height="1.5in" style="display: block; margin: auto;" />
...
<img src="doubledip.jpg" width="80%" height="2.2in" style="display: block; margin: auto;" />
...
<font color='gray'>Don't worry if you find this discussion of level sets confusing. We will come back to it later in the module for a more specific case.</font>
...
<img src="contourcombos.png" width="80%" height="2.2in" style="display: block; margin: auto;" />

Connect values of x and z that lead to the same value of y.


<img src="contourlines_example.png" width="80%" height="2.2in" style="display: block; margin: auto;" />
...
<img src="simeqn.png" width="80%" height="2.2in" style="display: block; margin: auto;" />
...
*Note:* <font color='gray'>In the real world, you might collect data like this and want to 'fit a line' to it. But it will never such a precise fit (you will fit a 'regression line' to minimise the deviations), and the 'all else equal' assumption is always an issue.</font>
...
<img src="mortys-mind-blower.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<img src="indifccurve.png" width="80%" height="2.2in" style="display: block; margin: auto;" />
...
<font color='blue'>Q:  How do we know</font> $E \succ A$ ?^[$B \sim A$ because they are on the same indifference curve
...
<img src="indifcurvebalance.png" width="80%" height="2.4in" style="display: block; margin: auto;" />
...
<img src="indifcurvemap.png" width="80%" height="2.2in" style="display: block; margin: auto;" />
...
<img src="particularpreferences.png" width="80%" height="2.4in" style="display: block; margin: auto;" />
...
<font color='blue'>What may be a critique, exception to this logic, e.g., for a particular food?</font>
...
<font color='gray'>These issues are decently addressed in the most recent edition 12.</font>
...
\begin{figure}[h]
  \centering
    <img src="budgetconstraint.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<font color='red'>Be careful</font>: it is very easy to get this slope ratio backwards!
...
<font color='blue'>Work on</font> making sure you can calculate the slope and intercept, what they mean, and have intuition for why the slope has this formula. See 'micro quiz 2.3')
...
<font color='gray'>Having trouble understanding the budget constraint computations? There is a great interactive exercise [HERE](http://web.mit.edu/11.203/www/econ/), click on 'budget constraint'.</font>
...
<img src="utilmax.png" width="80%" height="2.4in" style="display: block; margin: auto;" />
...
<img src="glasses.png" width="80%" height=".7in" style="display: block; margin: auto;" />
...
<font color='RawSienna'>Advanced maths: The derivation of the MRS is optional material.</font>
...
<font color='RawSienna'>Adv: This is a simple case of the implicit function theorem, essentially $U(X,Y)=c$ defines an implicit function $Y(X)$, whose slope is the negative of the ratio of the derivatives.</font>
...
- The above applies to any *interior* solution
    ...
    - <font color='RawSienna'>Advanced: This is a 'necessary but not sufficient condition', sufficient if there is a diminishing MRS everywhere.</font>
...
^[<font color='RawSienna'>Advanced: The same condition applies to each good you are consuming a positive amount of. </font>]

<img src="goodwedontbuy.png" width="80%" height="2.4in" style="display: block; margin: auto;" />



## App 2.4: ticket scalping

<img src="scalping.png" width="80%" height="2.4in" style="display: block; margin: auto;" />
...
<font color='RawSienna'>Adv: Tough questions (final exam-worthy):</font>
...
<img src="williesuncle.png" width="80%" height="2.2in" style="display: block; margin: auto;" />
...
Graphically, how much \$ would have been enough to compensate for abstaining?^[<font color='RawSienna'>Adv: Hard question, foreshadowing future concepts like the inefficiency of in-kind subsidies... How much would Willie need to be paid to get him to U_3 *without* the restriction?  Is this more or less than $5k?</font>]
...
<font color='red'>Warning:</font> Thinking caps on. This may be confusing.

Consider: are the following 'perfect substitutes' for someone who wants caffeine, but has no taste buds?


<img src="amount-of-caffeine-in-drinks.jpg" width="80%" height="1.5in" style="display: block; margin: auto;" />
...
<font color='red'>Warning:</font> On the other hand, if goods are *not* perfect substitutes, margunal utility ratios (thus,  marginal rates of substitution) generally depend on consumption levels.
...
E.g., where X is bicycle frames and Y bicycle wheels. <font color='red'>Warning:</font> this min function seems backwards, but it's correct. I've answered this question many times in office hours and on the forum (have a look).  No one believes me at first but in the end they realize that this is the case.
...
<font color='RawSienna'>Adv, maths: This slope is derived through calculus. </font>^[
...
# (Chapter 3) Demand Curves [2 hours] (L3)
...
<img src="normalgood.png" width="80%" height="2.2in" style="display: block; margin: auto;" />



<font color='gray'>Move to PPT slides to illustrate this, beginning with 'Changes in Income: A Normal Good'. See</font> [here](https://www.dropbox.com/s/qhsl6qey0wjcfe5/utility_demand_supplement.pptx?dl=0)




<img src="inferiorgood.png" width="80%" height="2.2in" style="display: block; margin: auto;" />
...
<font color='gray'>(More precisely, the effect on the lowest-cost consumption bundle yielding this utility.)</font>
...
<font color='RawSienna'>Advanced footnote</font>^[This standard definition of the 'income effect' of a price change combines both of the effects we saw when looking at the impact of an income change on consumption of X.
...
<img src="incomeandsubstfx.png" width="80%" height="2.2in" style="display: block; margin: auto;" />
...
<font color='RawSienna'>Advanced footnote</font>^[This topic is more nuanced and complicated than we will cover in the main content of this module. \
...
<img src="substfxperfect_trim.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="griffin.jpg" width="80%" height="2.2in" style="display: block; margin: auto;" />
...
<img src="cpi_bias.png" width="80%" height="2.7in" style="display: block; margin: auto;" />
...
<font color='gray'>I asked a multi-part question on this on the 2016 Final exam; have a look, these are all on the ELE under 'Relevant previous year's assessments, with suggested answer guidelines'</font> [2016 exam link](https://www.dropbox.com/s/ppbb89yflsey7n7/be2024fix_wans_2016.pdf?dl=0)
...
<img src="ukwindows.jpg" width="80%" height="2.6in" style="display: block; margin: auto;" />
...
<img src="tudoroverhang.jpg" width="80%" height="2.6in" style="display: block; margin: auto;" />
...
<img src="lumpsum1.png" width="80%" height="2.8in" style="display: block; margin: auto;" />
...
... quantity demanded for a substitute good B will go in the *same* direction as the price of A.^[<font color='RawSienna'>Adv:</font> These 'cross-price effects' include both *substitution* and *income* effects. (See micro quiz 3.3).]
...
<img src="dmd1.png" width="80%" height="2in" style="display: block; margin: auto;" />


<img src="dmd2.png" width="80%" height="2in" style="display: block; margin: auto;" />

<img src="dmd3.png" width="80%" height="2in" style="display: block; margin: auto;" />


<img src="dmd4.png" width="80%" height="2in" style="display: block; margin: auto;" />


## Shifts in an individual's demand curve

<font color='blue'>Q:  What might cause the demand curve for a product to shift (inward or outward)?</font>
...
<font color='red'>Be sure you understand shifts vs movements along, and 'demand' vs 'quantity demanded'.</font>
...
<font color='gray'>Numerical examples: these may be covered in tutorials</font>
...
<img src="cons_surplus.png" width="80%" height="2in" style="display: block; margin: auto;" />


<font color='RawSienna'>Advanced maths note</font>^[With a linear demand curve this is a triangle, which has an area that is easy to compute. More generally, this is a `definite integral'.]
...
<img src="summarketdemandcurve.png" width="80%" height="2in" style="display: block; margin: auto;" />

<font color='gray'>Numerical examples of this may be covered in tutorial</font>
...
<font color='gray'>However, the aggregate income does not have a single effect; it cannot be easily reduced to a single variable here. You can only express the demand curve as a function of aggregate income under restrictive assumptions. In general, it depends *who* gets this income. (See 'aggregation issues').</font>
...
<font color='RawSienna'>Advanced footnote</font>^[Strictly speaking we are talking about the limit of these responses, i.e., derivatives. \
...
# Production and costs (brief coverage) [30 min] (L4)
...
<font color='red'>This year</font> we only briefly cover the production function, inputs, and the firm's cost structure.
...
<font color='gray'> I'm not expecting you to know this input-choice optimisation in detail. I just wanted you to have a general sense of it as it helps us see how the model fits together.</font>
...
<img src="crsTCcurve.png" width="80%" height="2in" style="display: block; margin: auto;" />

***

<img src="crscostcurves" width="80%" height="2in" style="display: block; margin: auto;" />

***


<img src="drsTCcurve.png" width="80%" height="2in" style="display: block; margin: auto;" />

***

<img src="drscostcurves" width="80%" height="2in" style="display: block; margin: auto;" />

***

<img src="irsTCcurve.png" width="80%" height="2in" style="display: block; margin: auto;" />

***

<img src="irscosts_fix.png" width="80%" height="2in" style="display: block; margin: auto;" />
...
<font color='RawSienna'>Advanced footnote</font>^[This spawned a large literature on the 'theory of the firm' emphasizing things like incomplete contracts, hold-up, relationship specific assets, lobbying costs, and more.]
...
<img src="Mrillustrated.png" width="80%" height="3.5in" style="display: block; margin: auto;" />

***

**MR curves be like:**

<img src="mrcurve.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<font color='gray'>Note that for such a firm, the total revenue curve will be a straight line ... double quantity, double revenue</font>
...
<img src="fig8-1.png" width="80%" height="5.5in" style="display: block; margin: auto;" />
...
<img src="pcmcmr.png" width="80%" height="2in" style="display: block; margin: auto;" />
-->
...
# Perfect competition in a single market [NS Ch 9  (\*)] [1 hour] (L7)
...
<img src="srsupply.png" width="80%" height="2.7in" style="display: block; margin: auto;" />
...
<img src="srpd1.png" width="80%" height="3in" style="display: block; margin: auto;" />

***


<img src="srpd6.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<img src="incrcosts_lrsupply.png" width="80%" height="4in" style="display: block; margin: auto;" />
...
<img src="lr_supplyelast_ests.png" width="80%" height="2.7in" style="display: block; margin: auto;" />
...
<img src="prodsurp1.png" width="80%" height="2in" style="display: block; margin: auto;" />

***


<img src="prodsurp2.png" width="80%" height="2in" style="display: block; margin: auto;" />

***


<img src="prodsurp3.png" width="80%" height="2in" style="display: block; margin: auto;" />
...
<img src="consumerprodrsurplusmax.png" width="80%" height="1.5in" style="display: block; margin: auto;" />
...
<font color='blue'>Consider:</font> Should price-taking firms and perfect competition be our 'baseline' dominant model?

<font color='blue'>Is it reasonable to assume?</font>
...
<img src="hightower_cartoon1.png" width="80%" height="2in" style="display: block; margin: auto;" />

Efficiency in production?



<img src="self-checkout.jpg" width="80%" height="2in" style="display: block; margin: auto;" />
...
<img src="exchange_efcy.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="Contract-curve-on-edgeworth-box.png" width="80%" height="2in" style="display: block; margin: auto;" />
...
<img src="toplevelefficiency.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
# Market failure (One case: Public goods) [1 hour] (L8)
...
<img src="GES_sandwich_qns.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<img src="pubgoodspic.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="rivalexcludabletable1.png" width="80%" height="2.5in" style="display: block; margin: auto;" />



<img src="rivalexcludabletable.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="pgprovision1.png" width="80%" height="3.7in" style="display: block; margin: auto;" />
...
<img src="pgprovision2.png" width="80%" height="3.7in" style="display: block; margin: auto;" />
...
<img src="cleaningmatrix.png" width="80%" height="3.6in" style="display: block; margin: auto;" />
...
<font color='RawSienna'>Adv: or, allowing heterogeneous tastes, achieve a “potential Pareto improvement”; those who benefit could compensate those who are harmed and still all would be better off.</font>
...
# Monopolies and price discrimination [1-2 hours] {#monopolies-pd} (L9)
...
- <font color='blue'>Sixth problem set: Monopolies and price discrimination</font>
...
<img src="gaming_open.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="monopprofit1.png" width="80%" height="2.5in" style="display: block; margin: auto;" />

***

<img src="monopprofit2.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="monopprofit3.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="monopprofit4.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="monopprofitmax.png" width="80%" height="2.7in" style="display: block; margin: auto;" />
...
<img src="dwl1.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<img src="dwl2.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="dwl3.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="exeter_picturehouse.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="dwl3.png" width="80%" height="2in" style="display: block; margin: auto;" />

***


<img src="ppd1.png" width="80%" height="2.5in" style="display: block; margin: auto;" />

***

<img src="ppd2.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<font color='gray'>Note: To fully analyse these problems we need to know the techniques of 'mechanism design under asymmetric information', which we are not covering in this module</font>
...
<img src="ppd3.png" width="80%" height="2.5in" style="display: block; margin: auto;" />

***


<img src="ppd4.png" width="80%" height="2.5in" style="display: block; margin: auto;" />

***


<img src="ppd5.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="thirdclasscarriage.jpg" width="80%" height="1.5in" style="display: block; margin: auto;" />
...
<img src="discounts.png" width="80%" height="1.5in" style="display: block; margin: auto;" />

***

<img src="3dpd.png" width="80%" height="2in" style="display: block; margin: auto;" />
...
<img src="Price-discrimination-SNP2.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<img src="pdwelfare.png" width="80%" height="3in" style="display: block; margin: auto;" />

***

<img src="pdwelfareoverall.png" width="80%" height="3.5in" style="display: block; margin: auto;" />
...
# Uncertainty (with a bit of finance) [(2 hours), NS Chapter 4] (L10)
...
- <font color='blue'>Seventh problem set: Uncertainty (Chapter 4)</font>
...
<font color='gray'>Adv: Note, there are some debates, e.g., between 'Bayesians' and 'Frequentists' over the meaning of probability.</font>
...
<font color='RawSienna'>Adv, maths: When outcomes are in a continuous space, e.g., the returns to a stock can take any of an infinite number of possible values, the expected value becomes a definite integral rather than a sum.</font>
...
\
<!---
<img src="weirdalscissors.jpg" width="80%" height="2in" style="display: block; margin: auto;" />
-->
...
<img src="powerball.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<font color='gray'>Note: This is the net expected value of buying a $2 ticket. By this calculation each $2 ticket is worth $3.06 in expected value terms; however, with the adjustments further down in the article, we see this drops considerably and becomes negative in net after taxes.</font>
...
<font color='blue'>Consider: Which of the following are fair gambles?</font>
...
<img src="holtlaurie.png" width="80%" height="2.2in" style="display: block; margin: auto;" />
...
<img src="holtlauriedetail.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<img src="holtlauryresults.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
Imagine the realised utility $u(y)$ arises from the consumption chosen with income $y$ <font color='gray'>(btw, the utility arising from maximisation under a particular set of income and prices is called 'Indirect Utility')</font>
...
<font color='RawSienna'>Adv:} 	extcolor{gray</font>{Note that when we were choosing between two goods under certainty,
...
<font color='RawSienna'>Adv:} 	extcolor{gray</font>{This framework is justified by certain 'reasonable axioms' we might expect choices under uncertainty to follow,
...
<img src="riskaversion1.png" width="80%" height="2.5in" style="display: block; margin: auto;" />

*Note: You start with \$35k*

<img src="riskaversion2.png" width="80%" height="2.5in" style="display: block; margin: auto;" />


<img src="riskaversion3.png" width="80%" height="2.5in" style="display: block; margin: auto;" />


<img src="riskaversion4.png" width="80%" height="2.5in" style="display: block; margin: auto;" />


<img src="riskaversion5a.png" width="80%" height="2.5in" style="display: block; margin: auto;" />

## Ways of reducing risk: Insurance

 <img src="insurancereducesrisk.png" width="80%" height="3in" style="display: block; margin: auto;" />

Fair insurance
:     Insurance for which the premium is equal to the expected value of the loss

<font color='RawSienna}{Adv:} 	extcolor{gray'>We might think that such insurance is provided at its true marginal cost; however there are various reasons why the cost to firms may be above this, including transactions cost, moral hazard, and adverse selection</font>
...
<img src="oiltransitperformance.png" width="80%" height="1.7in" style="display: block; margin: auto;" />
...
<img src="diverselessrisk.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="marketriskline.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<img src="investorchoices.png" width="80%" height="3.5in" style="display: block; margin: auto;" />
...
# Game Theory [(2-3 hours), NS Chapter 5 and additional concepts/readings below] (L11)
...
<font color='gray'>Finally, behavioural economics</font>
...
<img src="Eeyore_Pink.jpg" width="80%" height="1.5in" style="display: block; margin: auto;" />
...
<img src="pd_normal.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<img src="pd_extensive.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<font color='red'>Warning:</font> this puzzle will do your head in

<img src="blue-eyed.png" width="80%" height="1.6in" style="display: block; margin: auto;" />
...
<img src="pd_normal.png" width="80%" height="2in" style="display: block; margin: auto;" />
    - In general, this may have no clear prediction

***

<img src="matrixforISD.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<font color='RawSienna'>Adv: There are differences between 'rationalizable' and 'survives ISD' but for our purposes these are the same</font>
...
<img src="matrixforISD.png" width="80%" height="2in" style="display: block; margin: auto;" />


<img src="isd1.png" width="80%" height="1.5in" style="display: block; margin: auto;" />

<img src="isd2.png" width="80%" height="1.5in" style="display: block; margin: auto;" />


<img src="isd3.png" width="80%" height="1.5in" style="display: block; margin: auto;" />
...
<img src="bossmall.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="pd_normal.png" width="80%" height="3.5in" style="display: block; margin: auto;" />
...
<img src="bosmatrix.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="matchpennies.png" width="80%" height="2in" style="display: block; margin: auto;" />
...
<img src="bosmatrix.png" width="80%" height="2in" style="display: block; margin: auto;" />
...
<img src="bosmatrix.png" width="80%" height="2.0in" style="display: block; margin: auto;" />
...
<img src="bosbr1.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="bosbr2.png" width="80%" height="2.5in" style="display: block; margin: auto;" />


<img src="bosbr3.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<font color='RawSienna}{Adv:} 	extcolor{gray'>Some texts and authors make this point about 'unpredictability' but others disagree (including myself). Making sure that it is impossible to predict your later play from your previous is only important if you are playing the same game repeatedly, and being observed.</font>

<font color='RawSienna'>Adv:} 	extcolor{gray</font>{It makes a bit more sense if we think about 'populations.
...
<img src="BOS_inlecture.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="coordgame_inlecture.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<img src="BOS_sequential.png" width="80%" height="2in" style="display: block; margin: auto;" />

*Note:* Remember, it's a one-shot game ... unrealistic within a marriage of course


<img src="BOS_sequential.png" width="80%" height="2.1in" style="display: block; margin: auto;" />
...
<img src="BOS_sequential.png" width="80%" height="1.9in" style="display: block; margin: auto;" />
...
<img src="bosbwi1.png" width="80%" height="1.5in" style="display: block; margin: auto;" />


<img src="bosbwi2.png" width="80%" height="1.5in" style="display: block; margin: auto;" />
...
<img src="bosbwi1.png" width="80%" height="1in" style="display: block; margin: auto;" />
...
<img src="longgamework_randompayoffs_noul.png" width="80%" height="2in" style="display: block; margin: auto;" />
...
<img src="longgamework_randompayoffs_ul.png" width="80%" height="2in" style="display: block; margin: auto;" />

***

In 'normal' (matrix form), stating complete contingent strategies:

<img src="longgame_matrix_full.png" width="80%" height="1.5in" style="display: block; margin: auto;" />
...
<img src="longgame_matrix_abbrev.png" width="80%" height="2in" style="display: block; margin: auto;" />


***

<img src="longgamework_randompayoffs_ul.png" width="80%" height="1.5in" style="display: block; margin: auto;" />
...
<img src="expeconlab.jpg" width="80%" height="2.2in" style="display: block; margin: auto;" />

***

<img src="ztreePD.png" width="80%" height="2.2in" style="display: block; margin: auto;" />
...
<img src="cooperPD.png" width="80%" height="2in" style="display: block; margin: auto;" />
...
<font color='gray'>If you are particularly interested, skim or read the introduction of any of the 'Handbooks' like 'Handbook of Experimental Economics'</font>
...
<img src="teenchoices.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<img src="isd4by3game.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<img src="entrygame.png" width="80%" height="3in" style="display: block; margin: auto;" />
...
<img src="paydayloan.png" width="80%" height="1.5in" style="display: block; margin: auto;" />
...
<img src="allaispies.png" width="80%" height="3.5in" style="display: block; margin: auto;" />
...
<img src="std_u_prospect_u.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="ktprospect.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="marshtest.jpg" width="80%" height="3in" style="display: block; margin: auto;" />
...
<font color='RawSienna}{Adv:} 	extcolor{gray'>The utilities, and decisions, of family members are highly connected. There is an ongoing debate and research programme considering when to model a household's decisions as 'unitary' and when to consider the individual preferences of the household members.</font>
...
<img src="ultimatumgametree.png" width="80%" height="2.5in" style="display: block; margin: auto;" />


<img src="ultimatumfairness.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="ultimatumenvy.png" width="80%" height="3.5in" style="display: block; margin: auto;" />
...
<font color='gray'>Note, These are basic game theoretic predictions, not Behavioral.</font>
...
<embed src="ult_table.pdf" width="80%" height="3.5in" style="display: block; margin: auto;" type="application/pdf" />
...
<img src="ultimatumgameoffers_Science.png" width="80%" height="3.5in" style="display: block; margin: auto;" />
...
<img src="borisbanks.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
Details:  <font color='gray}{2 rounds over 2 academic years}. 	extcolor{gray}{2 prizes in round 1, Amazon  only in round 2.}  	extcolor{gray}{First covering Faculty of Social Science, then all departments.} 	extcolor{gray'>Sign in with email, orthogonal employability treatments.</font>
...
<img src="beforeamazon.png" width="80%" height="2.5in" style="display: block; margin: auto;" />

<img src="wonamazon.png" width="80%" height="2.5in" style="display: block; margin: auto;" />

<img src="after_amazon.png" width="80%" height="2.5in" style="display: block; margin: auto;" />
...
<img src="BarGrDonpropHiBefore_vAfter.png" width="80%" height="3in" style="display: block; margin: auto;" />


<font color='RawSienna'>Adv: see <https://davidreinstein.wordpress.com/research-and-publications/> under 'working papers'</font>
...
<img src="beforeafer_allexp.png" width="80%" height="4in" style="display: block; margin: auto;" />
...
## Revisiony lecture: Behavioral economics (L13)
...
\underline{Evidence for Limited Cognitive Ability:} <font color='gray'>This is too long an answer, I'm just giving you some ideas</font>
...
<!--chapter:end:be2038handout_19.Rmd-->
