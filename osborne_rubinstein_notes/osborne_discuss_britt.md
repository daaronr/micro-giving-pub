...
**Britt: Ohhhhhhh I see. Is 'utility maximisation with a budget constrain' an example of a choice problem? If so, is 'minimising production cost for a given production function' also an example choice problem?** 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NDEwNjk3MjQsMTczOTQyMjEsMTMzNT
Q3OTc5N119
-->