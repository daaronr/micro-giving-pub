...
*Consider:* Here we see more income $\rightarrow$ less expenditure on Z!
Not just 'a lesser share' but actually *less*.
...
- (Left) when goods are perfect substitutes, there is no Substitution effect of a price change. For prices $l$ and $l'$, the minimum-cost consumption that attains $U_1$ is the same point (A,B)

- (Right) When goods are perfect complements, if the price changes, to attain $U_1$ at the lowest cost we must either
...
## App 3.2: The CPI and its biases {#cpi}
...
... quantity demanded for a substitute good B will go in the *same* direction as the price of A.^[`r format_with_col("Adv:","RawSienna")` These 'cross-price effects' include both *substitution* and *income* effects. (See NSmicro quiz 3.3).]
...
- This just sum the individual quantities demanded (at a given price)
