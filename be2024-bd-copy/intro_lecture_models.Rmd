...
A 'no-fluff' text from an esteemed source. Covers much of this module, but a bit at the more advanced side (actually the level varies greatly throughout). Includes calculus and lots of parametric examples.   Lots of solved problems.
...
#  Economic Models  [1 hour] (L1-2) {#models}
...
```{r  fig.cap = '', width='80%', fig.asp=.4, fig.align='center',  echo = FALSE}
...
making any choice.' <small>  PRMN, chapter 1, section 'Opportunity Cost' </small>^[[Principles of Economics - unnamed authors](https://open.umn.edu/opentextbooks/textbooks/principles-of-economics)  ]
...
# Math tools etc -  NS Chapter 1a -- coverage outline {#math-tools}
...
## Changing world oil prices, also 

Application 1A.3 in NS, also discussed in 
