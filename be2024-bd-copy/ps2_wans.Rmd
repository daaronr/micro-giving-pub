...
Suppose for a particular consumption plan an individual’s MRS (of steak for beer) is 2. That is, at this consumption plan he or she would be willing to give up 3 beers to get an extra steak. Suppose also that the price of a steak is £1 and a beer is £0.25 (i.e,. 25p)
...
$2\ell+ \ell=50\rightarrow3\ell=50\rightarrow\text{\ensuremath{\ell}=50/3}$
