# Notes to students, outline {-#note}
...
## On this online resource and the textbook options {-}

A key textbook is **Nicholson/Snyder, Intermediate Microeconomics and its Application**, 12th edition (other editions are OK too).

This text aligns with a great deal of this module. I recommend you purchase, or find easy access to some edition of this book (new editions should be £50, used editions should be cheaper), the publisher also sells an online-only version. In the future I hope to turn this online resource into a full interactive, collaborative, open-access online text, adapting material from other open-access resources, but I am not there yet.

```{block2,  type='note'}
Update: Free online access to this text may be available through your university/library (this works at Exeter) via [www.vlebooks.com](https://www.vlebooks.com/)
```  
...
In particular, the open source online text
[Microeconomics - markets, methods and models by Curtis and Irvine](https://open.umn.edu/opentextbooks/textbooks/microeconomics-markets-methods-and-models) covers much of the same material, and I draw from it substantially (with attribution under the CC license) in this web resource.

[Principles of Economics - unnamed authors](https://open.umn.edu/opentextbooks/textbooks/principles-of-economics) is also very related, and appears pretty good, I also draw from it heavily (with attribution under the CC license) in this web resource. (Referred to as 'PRUM')
...
- '[CM](https://open.umn.edu/opentextbooks/textbooks/microeconomics-markets-methods-and-models)' refers to [Microeconomics - markets, methods and models by Curtis and Irvine](https://open.umn.edu/opentextbooks/textbooks/microeconomics-markets-methods-and-models)

- '[PRUM](https://open.umn.edu/opentextbooks/textbooks/principles-of-economics)' refers to [Principles of Economics - unnamed authors](https://open.umn.edu/opentextbooks/textbooks/principles-of-economics), University of Minnesota
...
## Outline and description {-#outline}
