...
# BEE2038: Introduction and 'models'
...
# Lecture1 "intro" coverage (1 hour)
...
```{r  fig.cap = '', out.width='100%', out.height='100%',  fig.align='center',  echo = FALSE}
...
**Recommended:** "Intermediate Microeconomics and Its Application" (12th ed. or any recent); £50 Waterstones, also at the library; **get access**
...
```{r  fig.cap = '', out.width='90%', fig.asp=.4, fig.align='center',  echo = FALSE}
 knitr::include_graphics("galaxy.jpg")
```
...
Contains all the lecture slide material *and more*, html links, etc.  As we progress...
...
Markets work well but not perfectly. Imperfections in existing markets $\rightarrow$ opportunities.** \
...
<center>
<big> Humans are not like billiard balls, universal rules are hard to come by}
</big> </center>
...
```{r  fig.cap = 'Most prominent cynic: Bryan Caplan', out.width='90%', fig.asp=.4, fig.align='center',  echo = FALSE}
...
<aside class="notes">6. ''Gasoline sells for \$4.00 per *gallon* this year, and it sold for \$3.00 per gallon last year.
 ...
 This is clear proof that the economic theory that people buy less when the price rises is incorrect.'' Do you agree? Explain.
</aside>
