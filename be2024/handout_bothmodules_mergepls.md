...
\textcolor{RawSienna}{Adv:} Note that the line between two bundles depicts all 'convex combinations' of these $\alpha$ of D and $1-\alpha$ of A, where $\alpha \in (0,1)$.
...
See formative assesments on the VLE, as well as problem set links

<!---

I've moved these to the file /Users/yosemite/OneDrive - University of Exeter/exeter_teaching/be2024/revisqns_end_of_firstpart.md
...
However, it seems likely that most people would choose a, even though it has a lower expected monetary value, because they are *risk-averse*.
...
Consider: Which *outcome* is *definitely NOT* Pareto-optimal (for the prisoners)?
...
Market equilibrium (recapping this): given the equilibrium price and quantity, no market participant has an incentive to change his or her behaviour.
...
\textcolor{red}{NOTE (2018-19):} Please know the basic principles; you don't need to \underline{compute} mixed strategies*
...
2018: NOT covering repeated games, not assessed on these
...
Note (2017): I require you know the **principle** here, **not** the computation. But **geometric discounting** is super-relevant for **finance** and for **cost-benefit analysis**, and issues like global warming,

and it also will come up again in behavioral economics.
...
*We are not covering games with continuous actions in 2018-19, for time concerns. All the games presented will have a finite number of actions; these can be simply depicted in matrices or game trees.*
...
- Lecture covers selected parts of NS: Ch 17 (but go aead and read the whole chapter, you will find it interesting), plus some supplements
...
\underline{Firms} maximise profit

\underline{Individuals/households} have a consistent utility function which they act 'rationally' to maximise. This is mainly focused on *own* consumption,  ignores 'cognitive costs', and ignores 'malleable and changing preferences'
...
Strategic behaviour in interactions:  Common knowledge of rationality (and perhaps convergence on a Nash equilibrium?)

***

We can find behaviour and outcomes that seem to contradict the above assumptions. This 'non-classical' behaviour is (arguably) common, significant, and follows predictable patterns
...
It does not typically 'reject rationality'; rather it assets 'bounded rationality'
...
A 'simplifying decision-making rule' (rule-of-thumb) may be better if it reduces these costs.

This is relevant both to individual decision-making (consumption, investment) and strategic choices; From  game theory: recall 'iterated strict dominance' and 'backwards induction'; this may be very difficult.
...
Consumers who underestimated interest rates in quizzes held the highest interest loans in real life (Stango and Zinman, 2011). This was particularly true where and when government 'truth in lending laws' were lax.
...
## Application: Give-if-you-win (EU vs. Prospect theory) - 2018: not covered, but you could consider this 'background reading'
...
\includegraphics[width=5.5in]{picsfigs/ultimatumgame2017_exam.png}
