...
<aside class="notes">Finally, behavioural economics, time permitting</aside>
...
<small>Rem: wife chooses Ballet (Box)<\small> $\rightarrow$ \footnotesize{husband BR is Ballet (Box)}

<small>Using 'EU': Compute Husb's payoff from playing Ballet \& from Boxing if Wife chooses Ballet w/ prob.<\small> $w$

. . .

$\rightarrow$ <small>'Threshold' prob. $\hat{w<\small>$ makes him indifferent; for $w<\hat{w}$, he chooses Box; for $w>\hat{w}$ he chooses Ballet.}
...
<small>... similarly, wife indifferent btwn her 2 choices for some prob. $\hat{h<\small>$; for $h<\hat{h}$, she chooses Box, for $h>\hat{h}$ she chooses Ballet.}
...
- <small>If she thinks he goes *exactly* 1/3 of the time she is indifferent<\small>
...
<small>Consider Battle of Sexes, but now Wife chooses first, Husband observes this and then chooses. What do you think will happen? Vote:<\small>
